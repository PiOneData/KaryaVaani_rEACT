      ...
      <div className="vb-panel active" id="vb-panel-0">
        ...
        <div className="vbm">
          ...
          <div className="vbm-row" id="vb-email-row">
            ...
            {' '}
            <div className="vbm-row-v">
              <input type="email" className="vbm-subject" id="vb-email-to" multiple placeholder="recipient@company.com" defaultValue="mouli@pionedata.com, sriramm.ramesh@pionedata.com" />
              {' '}
              <div className="vbm-row-hint">
